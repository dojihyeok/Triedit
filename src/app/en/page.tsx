            ...
            <section style={{
                ...
                <div className="container">
                    ...
                    <div className="animate-fade-in" style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                        <Link href="/en/reviews" className="btn btn-primary" style={{ fontSize: '1.1rem', padding: '0.8rem 2rem' }}>
                            Browse Experiences
                        </Link>
                        <Link href="/en/write" className="btn btn-ghost" style={{ fontSize: '1.1rem', padding: '0.8rem 2rem' }}>
