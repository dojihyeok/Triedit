...
export default async function ReviewDetailEnPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (!review) {
        return (
            <div className="container" style={{ padding: '4rem 0', textAlign: 'center' }}>
                ...
                <Link href="/en/reviews" className="btn btn-primary" style={{ marginTop: '1rem' }}>
                    Back to list
                </Link>
            </div>
        );
    ...
    return (
        <div className="container animate-fade-in" style={{ padding: '4rem 0', maxWidth: '800px' }}>
            <Link href="/en/reviews" style={{ color: 'var(--text-secondary)', textDecoration: 'none', marginBottom: '2rem', display: 'inline-block' }}>
                ← Back to list
            </Link>
